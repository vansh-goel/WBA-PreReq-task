export type WbaPrereq = {
  ...
  instructions: Array<{
    ...
    accounts: Array<{
      ...
      signer?: boolean;
      pda?: {
        seeds: Array<{ kind: string; value: number[] | string }>;
      };
      address?: string;
    }>;
    args: Array<{ name: string; type: 'bytes' | 'pubkey' }>;
  }>;
  accounts: Array<{
    name: string;
    discriminator: number[];
  ...
  types: Array<{
    ...
    type: {
      kind: 'struct';
      fields: Array<{ name: string; type: 'bytes' | 'pubkey' }>;
    };
  }>;
};
        ...
        { 
          ...
          pda: {
            seeds: [
              ...
              { kind: "account", value: "signer" }
            ]
          }
        },
        { name: "system_program", writable: false, address: "11111111111111111111111111111111" }
      ],
      args: [
